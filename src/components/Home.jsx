export default function Home() {
    return (
        <div className='z-10 flex-shrink-0 flex relative justify-center h-full w-screen items-center'>
            ...
            <div className='rounded-[25px] absolute right-[5rem] h-15 w-15 bg-yellow flex justify-center items-center '>
